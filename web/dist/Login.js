...
var _user$project$LoginStyle$styles = function (cssPairs) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(cssPairs));
};
var _user$project$LoginStyle$headerStyle = _user$project$LoginStyle$styles(
	{
		ctor: '::',
...
var _user$project$LoginStyle$inputTextStyle = _user$project$LoginStyle$styles(
	{
		ctor: '::',
...
var _user$project$LoginStyle$buttonStyle = _user$project$LoginStyle$styles(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$width(
			_rtfeldman$elm_css$Css$px(300)),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$backgroundColor(
				_rtfeldman$elm_css$Css$hex('#397cd5')),
			_1: {
				ctor: '::',
...
var _user$project$Login$User = F3(
	function (a, b, c) {
		return {username: a, password: b, loggedIn: c};
	});
var _user$project$Login$initialModel = A3(_user$project$Login$User, '', '', false);
...
var _user$project$Login$view = function (user) {
	return user.loggedIn ? A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(user)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}) : A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$LoginStyle$headerStyle,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _user$project$LoginStyle$inputTextStyle,
													_1: {
														ctor: '::',
...
var _user$project$Login$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Login$initialModel, view: _user$project$Login$view, update: _user$project$Login$update})();
