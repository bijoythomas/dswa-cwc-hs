...
var _user$project$Login$handleLoginResponse = F2(
...
var _user$project$Login$authUserCmd = F2(
	function (user, apiUrl) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Login$HandleLoginResponse,
			A2(_user$project$Login$authUser, user, apiUrl));
	});
		...
		switch (_p3.ctor) {
			...
			case 'Login':
				return {
					ctor: '_Tuple2',
					_0: user,
					_1: A2(_user$project$Login$authUserCmd, user, _user$project$Login$loginUrl)
				};
			case 'LogOut':
				return {
					ctor: '_Tuple2',
...
var _user$project$Login$view = function (user) {
	var showError = _elm_lang$core$String$isEmpty(user.errorMsg) ? 'hidden' : '';
	var content = user.loggedIn ? {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(user.errorMsg),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
